...
{
    public class MLRankingRankSVMNonLinear: RankingFunction
    {
        private static Dictionary<Feature, double> weights;

        public MLRankingRankSVMNonLinear()
        {
            weights = new Dictionary<Feature, double>();
            weights.Add(Feature.Intercept, 0);
            weights.Add(Feature.Constants, 6.6277);
            weights.Add(Feature.References, 29.3951);
            weights.Add(Feature.Concrete, -116.7367);
            weights.Add(Feature.Abstract, 107.3749);
            weights.Add(Feature.Nodes, 151.5546);
            weights.Add(Feature.Patterns, 94.60242);
            weights.Add(Feature.ParentOne, 40.70553);
            weights.Add(Feature.ParentTwo, 0);
            weights.Add(Feature.ParentThree, 0);
            weights.Add(Feature.NodeItSelf, -4.931217);
            weights.Add(Feature.Size, 554.0746);
            weights.Add(Feature.Operations, 2.236376);
            weights.Add(Feature.Constants_squared, 44.19537);
            weights.Add(Feature.References_squared, 76.17611);
            weights.Add(Feature.Concrete_squared, -1874.579);
            weights.Add(Feature.Abstract_squared, 880.0215);
            weights.Add(Feature.Nodes_squared, 2755.087);
            weights.Add(Feature.Patterns_squared, 321.1865);
            weights.Add(Feature.ParentOne_squared, 125.263);
            weights.Add(Feature.ParentTwo_squared, 0);
            weights.Add(Feature.ParentThree_squared, 0);
            weights.Add(Feature.NodeItSelf_squared, -8.603547);
            weights.Add(Feature.Size_squared, 43718.69);
            weights.Add(Feature.Operations_squared, 6.709127);
            weights.Add(Feature.Constants_cubic, 176.6385);
            weights.Add(Feature.References_cubic, 101.677);
            weights.Add(Feature.Concrete_cubic, -28908.52);
            weights.Add(Feature.Abstract_cubic, 7031.52);
            weights.Add(Feature.Nodes_cubic, 40463.53);
            weights.Add(Feature.Patterns_cubic, -42200.9);
            weights.Add(Feature.ParentOne_cubic, 199.9167);
            weights.Add(Feature.ParentTwo_cubic, 0);
            weights.Add(Feature.ParentThree_cubic, 0);
            weights.Add(Feature.NodeItSelf_cubic, -15.94821);
            weights.Add(Feature.Size_cubic, 785907.1);
            weights.Add(Feature.Operations_cubic, 15.65463);
