...
{
    public class MLRankingSVMNonLinear: RankingFunction
    {
        private static Dictionary<Feature, double> weights;

        public MLRankingSVMNonLinear()
        {
            weights = new Dictionary<Feature, double>();
            weights.Add(Feature.Intercept, 0.2116);
            weights.Add(Feature.Constants, 1.6735);
            weights.Add(Feature.References, -2.5674);
            weights.Add(Feature.Concrete, 0.1994);
            weights.Add(Feature.Abstract, -0.0012);
            weights.Add(Feature.Nodes, -0.8811);
            weights.Add(Feature.Patterns, -0.0703);
            weights.Add(Feature.ParentOne, -0.7766);
            weights.Add(Feature.ParentTwo, 0);
            weights.Add(Feature.ParentThree, 0);
            weights.Add(Feature.NodeItSelf, 0.3415);
            weights.Add(Feature.Size, 0.0161);
            weights.Add(Feature.Operations, 0.2807);
