...
{
    public class MLRankingSVMNonLinearNoConcrete: RankingFunction
    {
        private static Dictionary<Feature, double> weights;

        public MLRankingSVMNonLinearNoConcrete()
        {
            weights = new Dictionary<Feature, double>();
            weights.Add(Feature.Intercept, 2.2059);
            weights.Add(Feature.Constants, -0.3552);
            weights.Add(Feature.References, -1.5286);
            weights.Add(Feature.Concrete, 1000);
            weights.Add(Feature.Abstract, -0.1779);
            weights.Add(Feature.Nodes, -0.4731);
            weights.Add(Feature.Patterns, 0.1918);
            weights.Add(Feature.ParentOne, -0.8265);
            weights.Add(Feature.ParentTwo, 0);
            weights.Add(Feature.ParentThree, 0);
            weights.Add(Feature.NodeItSelf, 0.2055);
            weights.Add(Feature.Size, -0.0389);
            weights.Add(Feature.Operations, 0.8604);
            weights.Add(Feature.Constants_squared, -0.1903);
            weights.Add(Feature.References_squared, 0.1993);
            weights.Add(Feature.Concrete_squared, 0);
            weights.Add(Feature.Abstract_squared, -0.1773);
            weights.Add(Feature.Nodes_squared, 0.0020);
            weights.Add(Feature.Patterns_squared, 0.0090);
            weights.Add(Feature.ParentOne_squared, 0.1817);
            weights.Add(Feature.ParentTwo_squared, 0);
            weights.Add(Feature.ParentThree_squared, 0);
            weights.Add(Feature.NodeItSelf_squared, -0.1966);
            weights.Add(Feature.Size_squared, -0.0005);
            weights.Add(Feature.Operations_squared, 0.1315);
            weights.Add(Feature.Constants_cubic, 0.1391);
            weights.Add(Feature.References_cubic, 0.0622);
            weights.Add(Feature.Concrete_cubic, 0);
            weights.Add(Feature.Abstract_cubic, 0.0651);
            weights.Add(Feature.Nodes_cubic, 0.0044);
            weights.Add(Feature.Patterns_cubic, 0.0002);
            weights.Add(Feature.ParentOne_cubic, 0.0530);
            weights.Add(Feature.ParentTwo_cubic, 0);
            weights.Add(Feature.ParentThree_cubic, 0);
            weights.Add(Feature.NodeItSelf_cubic, 0.0199);
            weights.Add(Feature.Size_cubic, -0.00001);
            weights.Add(Feature.Operations_cubic, -0.0615);
