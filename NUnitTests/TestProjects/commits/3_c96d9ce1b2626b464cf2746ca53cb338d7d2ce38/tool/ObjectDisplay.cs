...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal static class ObjectDisplay
    {
        ...
        internal static string FormatLiteral(bool value, ObjectDisplayOptions options)
        {
            return value ? "true" : "false";
        }

        internal static string FormatString(string str, ObjectDisplayOptions options)
        {
