...
namespace ExampleProject.Company.ExampleProject.ReturnToGet
{
    public class ReturnToGet
    {
        ...
        {
            get { return ImmutableArray<string>.Create(StaticTypeRulesDiagnosticAnalyzer.CA1052RuleId); }
        }

        public sealed override ImmutableArray<string> GetFixableDiagnosticIds2
        {
            get { return ImmutableArray<string>.Create(CA1001DiagnosticAnalyzer.RuleId); }
        }
