...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        public BoundTypeOrValueExpression(CSharpSyntaxNode syntax, Symbol valueSymbol, BoundExpression valueExpression, ImmutableArray<Microsoft.CodeAnalysis.Diagnostic> valueDiagnostics, BoundExpression typeExpression, ImmutableArray<Microsoft.CodeAnalysis.Diagnostic> typeDiagnostics, TypeSymbol type, bool hasErrors = false)
            : base(BoundKind.TypeOrValueExpression, syntax, type, hasErrors || valueExpression.HasErrors() || typeExpression.HasErrors())
        {
        ...
        public Symbol ValueSymbol { get; private set; }

        public BoundExpression ValueExpression { get; private set; }

        public ImmutableArray<Microsoft.CodeAnalysis.Diagnostic> ValueDiagnostics { get; private set; }

        public BoundExpression TypeExpression { get; private set; }

        public ImmutableArray<Microsoft.CodeAnalysis.Diagnostic> TypeDiagnostics { get; private set; }
        ...
        public BoundTypeOrValueExpression Update(Symbol valueSymbol, BoundExpression valueExpression, ImmutableArray<Microsoft.CodeAnalysis.Diagnostic> valueDiagnostics, BoundExpression typeExpression, ImmutableArray<Microsoft.CodeAnalysis.Diagnostic> typeDiagnostics, TypeSymbol type)
        {
            if (valueSymbol != this.ValueSymbol || valueExpression != this.ValueExpression || valueDiagnostics != this.ValueDiagnostics || typeExpression != this.TypeExpression || typeDiagnostics != this.TypeDiagnostics || type != this.Type)
            {
                var result = new BoundTypeOrValueExpression(this.Syntax, valueSymbol, valueExpression, valueDiagnostics, typeExpression, typeDiagnostics, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundUserDefinedConditionalLogicalOperator(CSharpSyntaxNode syntax, BinaryOperatorKind operatorKind, BoundExpression left, BoundExpression right, MethodSymbol logicalOperator, MethodSymbol trueOperator, MethodSymbol falseOperator, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
        ...
        public MethodSymbol LogicalOperator { get; private set; }

        public MethodSymbol TrueOperator { get; private set; }

        public MethodSymbol FalseOperator { get; private set; }
    ...
    {
        public BoundIteratorScope(CSharpSyntaxNode syntax, ImmutableArray<StateMachineFieldSymbol> fields, BoundStatement statement, bool hasErrors = false)
        ...
        public ImmutableArray<StateMachineFieldSymbol> Fields { get; private set; }
        ...
        public BoundIteratorScope Update(ImmutableArray<StateMachineFieldSymbol> fields, BoundStatement statement)
        {
    ...
    {
        public BoundSwitchStatement(CSharpSyntaxNode syntax, BoundExpression boundExpression, LabelSymbol constantTargetOpt, ImmutableArray<LocalSymbol> innerLocals, ImmutableArray<BoundSwitchSection> switchSections, GeneratedLabelSymbol breakLabel, MethodSymbol stringEquality, bool hasErrors = false)
        ...
        public BoundSwitchStatement Update(BoundExpression boundExpression, LabelSymbol constantTargetOpt, ImmutableArray<LocalSymbol> innerLocals, ImmutableArray<BoundSwitchSection> switchSections, GeneratedLabelSymbol breakLabel, MethodSymbol stringEquality)
        {
            if (boundExpression != this.BoundExpression || constantTargetOpt != this.ConstantTargetOpt || innerLocals != this.InnerLocals || switchSections != this.SwitchSections || breakLabel != this.BreakLabel || stringEquality != this.StringEquality)
            {
                var result = new BoundSwitchStatement(this.Syntax, boundExpression, constantTargetOpt, innerLocals, switchSections, breakLabel, stringEquality, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundDoStatement(CSharpSyntaxNode syntax, BoundExpression condition, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel, bool hasErrors = false)
    ...
    {
        public BoundWhileStatement(CSharpSyntaxNode syntax, BoundExpression condition, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel, bool hasErrors = false)
    ...
    {
        public BoundForStatement(CSharpSyntaxNode syntax, ImmutableArray<LocalSymbol> outerLocals, BoundStatement initializer, BoundExpression condition, BoundStatement increment, BoundStatement body, GeneratedLabelSymbol breakLabel, GeneratedLabelSymbol continueLabel, bool hasErrors = false)
    ...
    {
        public BoundCatchBlock(CSharpSyntaxNode syntax, LocalSymbol localOpt, BoundExpression exceptionSourceOpt, TypeSymbol exceptionTypeOpt, BoundExpression exceptionFilterOpt, BoundBlock body, bool hasErrors = false)
        ...
        public BoundCatchBlock Update(LocalSymbol localOpt, BoundExpression exceptionSourceOpt, TypeSymbol exceptionTypeOpt, BoundExpression exceptionFilterOpt, BoundBlock body)
        {
            if (localOpt != this.LocalOpt || exceptionSourceOpt != this.ExceptionSourceOpt || exceptionTypeOpt != this.ExceptionTypeOpt || exceptionFilterOpt != this.ExceptionFilterOpt || body != this.Body)
            {
                var result = new BoundCatchBlock(this.Syntax, localOpt, exceptionSourceOpt, exceptionTypeOpt, exceptionFilterOpt, body, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    {
        public BoundObjectInitializerMember(CSharpSyntaxNode syntax, Symbol memberSymbol, ImmutableArray<BoundExpression> arguments, ImmutableArray<string> argumentNamesOpt, ImmutableArray<RefKind> argumentRefKindsOpt, bool expanded, ImmutableArray<int> argsToParamsOpt, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundFieldAccess(CSharpSyntaxNode syntax, BoundExpression receiverOpt, FieldSymbol fieldSymbol, ConstantValue constantValueOpt, LookupResultKind resultKind, bool isByValue, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundNameOfOperator(CSharpSyntaxNode syntax, BoundExpression argument, ConstantValue constantValueOpt, TypeSymbol type, bool hasErrors = false)
    ...
    {
        public BoundInterpolatedString(CSharpSyntaxNode syntax, ImmutableArray<BoundExpression> parts, TypeSymbol type, bool hasErrors = false)
        ...
        public ImmutableArray<BoundExpression> Parts { get; private set; }
    ...
    {
        public BoundStringInsert(CSharpSyntaxNode syntax, BoundExpression value, BoundExpression alignment, BoundExpression format, TypeSymbol type, bool hasErrors = false)
        ...
        public BoundExpression Alignment { get; private set; }

        public BoundExpression Format { get; private set; }
    ...
    internal abstract partial class BoundTreeWalker: BoundTreeVisitor
    {
        ...
        public override BoundNode VisitTypeOrValueExpression(BoundTypeOrValueExpression node)
        {
            ...
            this.Visit(node.TypeExpression);
            return null;
        }
    ...
    internal abstract partial class BoundTreeRewriter : BoundTreeVisitor
    {
        ...
        public override BoundNode VisitTypeOrValueExpression(BoundTypeOrValueExpression node)
        {
            BoundExpression valueExpression = (BoundExpression)this.Visit(node.ValueExpression);
            BoundExpression typeExpression = (BoundExpression)this.Visit(node.TypeExpression);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(node.ValueSymbol, valueExpression, node.ValueDiagnostics, typeExpression, node.TypeDiagnostics, type);
        }
        public override BoundNode VisitNamespaceExpression(BoundNamespaceExpression node)
        {
            TypeSymbol type = this.VisitType(node.Type);
        ...
        public override BoundNode VisitSwitchStatement(BoundSwitchStatement node)
        {
            ...
            return node.Update(boundExpression, node.ConstantTargetOpt, node.InnerLocals, switchSections, node.BreakLabel, node.StringEquality);
        }
        public override BoundNode VisitSwitchSection(BoundSwitchSection node)
        {
        ...
        public override BoundNode VisitCatchBlock(BoundCatchBlock node)
        {
            ...
            return node.Update(node.LocalOpt, exceptionSourceOpt, exceptionTypeOpt, exceptionFilterOpt, body);
        }
        public override BoundNode VisitLiteral(BoundLiteral node)
        {
            TypeSymbol type = this.VisitType(node.Type);
    ...
    internal sealed class BoundTreeDumperNodeProducer : BoundTreeVisitor<object, TreeDumperNode>
    {
        ...
        public override TreeDumperNode VisitTypeOrValueExpression(BoundTypeOrValueExpression node, object arg)
        {
            return new TreeDumperNode("typeOrValueExpression", null, new TreeDumperNode[]
            {
                ...
                new TreeDumperNode("valueExpression", null, new TreeDumperNode[] { Visit(node.ValueExpression, null) }),
                new TreeDumperNode("valueDiagnostics", node.ValueDiagnostics, null),
                new TreeDumperNode("typeExpression", null, new TreeDumperNode[] { Visit(node.TypeExpression, null) }),
                new TreeDumperNode("typeDiagnostics", node.TypeDiagnostics, null),
                new TreeDumperNode("type", node.Type, null)
            }
            );
        }
        ...
        public override TreeDumperNode VisitLocalDeclaration(BoundLocalDeclaration node, object arg)
        {
            return new TreeDumperNode("localDeclaration", null, new TreeDumperNode[]
            {
                ...
                new TreeDumperNode("argumentsOpt", null, node.ArgumentsOpt.IsDefault ? SpecializedCollections.EmptyArray<TreeDumperNode>() : from x in node.ArgumentsOpt select Visit(x, null))
            }
            );
        }
        ...
        {
            return new TreeDumperNode("yieldBreakStatement", null, SpecializedCollections.EmptyArray<TreeDumperNode>()
            );
        }
