...
namespace TreeEdit.Spg.Script
{
    ...
    {
        public Delete(TreeNode<T> deletedNode) : base(deletedNode, deletedNode.Parent, -1)
        {
        }
        ...
        {
            return K == other.K && other.T1Node.IsLabel(T1Node.Label) && other.Parent.IsLabel(Parent.Label);
        }
    }
}
